...
"""
This module sets up the OpenAI API key for use in the project.
"""

openai.api_key = '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'
...
class RetrievalAssistant:
    ...
    def _get_assistant_response(self, prompt):
      try:
        ...
        # Here, instead of returning a string, we return a dict to maintain the consistency
        return {'role': 'assistant', 'content': f'Request failed with exception {e}'}
    ...
    def ask_assistant(self, next_user_prompt):
      ...
      if 'searching for answers' in assistant_response['content'].lower():
        question_extract = openai.Completion.create(
          ...
          prompt=f'''
          Extract the user's latest question from this conversation: {self.conversation_history}. 
          Extract it as a sentence stating the Question."
        '''
        )
